 ...
 *
 */
$view_folder = dirname(__FILE__) . '/../application/themes';
 ...
 * --------------------------------------------------------------
 *
 * This is the path to the vendor folder.
 */
$vendor_folder = realpath(dirname(__FILE__)) . "/../vendor";
 ...
 *
 */
$ciunit_folder = $vendor_folder . '/celc/ciunit/src/';
